...
import { NewCandidat, userSelector, clearState, IsExpired, studentIsPassive } from './UserSlice';
...
const Beacandidate = () => {
  ...
  const { isFetching, isSuccess, isError, errorMessage, isSaved, IsEx, IsPassive } = useSelector(
    userSelector
  );
  ...
  return (
    <div className="container-fluid mx-auto vrrfdc h-100">
      <Fragment>       
          ...
          <div className="col-md-6 offset-md-3 col-xs-12 card" style={{ marginTop: "5px", background: "white", padding: "10px 25px" }}>
